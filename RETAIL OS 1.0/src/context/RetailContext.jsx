...
export const RetailProvider = ({ children }) => {
  ...
  React.useEffect(() => {
    ...
    localStorage.setItem("ros_theme_mode", JSON.stringify(activeTheme));
  ...
  }, [themeMode, themePreference, accessibilityMode, reducedMotion]);
